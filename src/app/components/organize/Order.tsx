...
function Order() {
  return (
    <div className='flex w-full h-[300px] justify-center items-center  '>
        <div className=' flex bg-red-600 w-[1300px] rounded-xl h-[270px] mb-4 justify-center gap-3 p-2  '>
...
</div><div className='flex flex-col w-[200px] rounded-lg bg-red-600 justify-center items-center'>
  <Link href="" >
<h3 className='p-2 text-white justify-center items-center font-bold hover:text-gray-700 text-2xl w-[75px]'>پیشنهاد شگفت انگیز</h3></Link>
<Image src="/menu/Box.png" width={100} height={25} alt='pic' className='hover:p-4'/>
<Link href="">
