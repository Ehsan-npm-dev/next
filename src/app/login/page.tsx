...
function page() {
  return (
    <div className="flex flex-col justify-center items-center h-[100vh]">
      <div className="w-[300px] gap-3 border rounded-lg justify-center items-center flex flex-col p-4">
        <Image
          src="/img/logo.svg"
          alt="logo"
          width={80}
          height={20}
          className="flex justify-center items-center pb-2 w-[120px] pt-2 "
        />
        <h3 className="flex font-bold  ml-28 flex-row-reverse w-28 text-center ">ورود | ثبت‌نام</h3>
        <small className="pl-[199px]">سلام!</small>
        <p className="text-[12px] ml-12 text-gray-600  ">: لطفا شماره موبایل خود را وارد کنید</p>
